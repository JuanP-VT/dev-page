...
export const Projects: Project[] = [
	...
	},
	{
		...
		description:
			"Engineered a high-efficiency storage migration, offloading legacy file records from MySQL (Base64) to AWS S3. By eliminating the 33% storage overhead inherent in Base64 encoding, I reduced database bloat and improved query latency, resulting in a 30% reduction in storage costs and more reliable data backups for the enterprise.",
	...
	},
	{
		...
		description:
			"Architected a secure digital-asset delivery system using AWS S3 and Signed URLs, ensuring content protection and automated distribution following PayPal verification. Developed a custom end-to-end architecture to handle high-resolution digital downloads, reducing manual overhead for the business owner.",
	...
	},
	{
		...
		description:
			"Implemented a Headless CMS (Contentful) to decouple content management from the frontend, enabling non-technical stakeholders to perform independent site updates without code deployments. Optimized site performance and SEO through Next.js server-side rendering, significantly increasing client engagement and discovery.",
	...
	},
	{
		...
		description:
			"Developed a fullstack inventory management tool. Implemented a robust Fullstack architecture featuring NoSQL schema design, and a responsive administrative dashboard.",
