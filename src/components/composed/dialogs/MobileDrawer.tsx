...
export default function MobileDrawer() {
  ...
  return (
    <div
      className={clsx(
        'fixed top-[64px] z-50 flex h-fit w-full flex-col rounded-b-lg bg-white p-2 shadow-lg transition-transform duration-500 lg:hidden dark:border-r dark:border-gray-700/50 dark:bg-gray-800 dark:text-gray-200',
        {
