...
const technologies = {
  frontend: [
    {
      name: "JavaScript",
      icon: <IoLogoJavascript className="w-6 h-6 text-yellow-500 dark:text-yellow-300" />      
    },
    {
      name: "TypeScript",
      icon: <SiTypescript className="w-6 h-6 text-blue-800 dark:text-blue-500" />
    },
    {
      name: "React",
    ...
    {
      name: "Tailwind",
      icon: <SiTailwindcss className="w-6 h-6 text-sky-500 dark:text-sky-300" />      
    },
    {
      name: "Jest",
  ...
  backend: [
    ...
    {
      name: "MongoDB",
      icon: <SiMongodb className="w-6 h-6 text-green-600 dark:text-green-400" />      
    },
		{
      name: "XUnit",
      icon: <LuTestTube  className="w-6 h-6 text-gray-600 dark:text-gray-400" />      
    },
  ],
  tools: [
    {
    ...
    {
      name: "Docker",
      icon: <FaDocker className="w-6 h-6 text-sky-600 dark:text-sky-400" />,
    },
    {
      name: "AWS",
      icon: <FaAws className="w-6 h-6 text-yellow-600 dark:text-yellow-400" />,
		    ...
		    {
      name: "Azure",
      icon: <TbBrandAzure className="w-6 h-6 text-blue-600 dark:text-blue-400" />,
    },
		    {
      name: "Figma",
      icon: <FaFigma className="w-6 h-6 text-orange-600 dark:text-orange-400" />,
    },
  ],
};
